...
const PLANES_INFO = {
  'pack-inicial': {
    ...
    items: ['3 paneles AlpSolar 610W N-TYPE', 'Inversor híbrido PULSE S4 12 kW',
            'Batería LiFePO4 5.12 kWh LIVO-Y', 'Cableado, cajas de protección y soporte',
  ...
  'pack-intermedio': {
    ...
    items: ['6 paneles AlpSolar 610W N-TYPE', 'Inversor híbrido PULSE S4 12 kW',
            '2× Batería LiFePO4 5.12 kWh LIVO-Y', 'Cableado, cajas de protección y soporte',
            'Instalación y puesta en marcha'],
  },
  'pack-full': {
    nombre: 'Pack Full',
    ...
    items: ['10 paneles AlpSolar 610W N-TYPE', 'Inversor híbrido PULSE S4 12 kW',
            '3× Batería LiFePO4 5.12 kWh LIVO-Y', 'Cableado, cajas de protección y soporte',
            'Instalación y puesta en marcha'],
  },
  'plan-estandar': {
