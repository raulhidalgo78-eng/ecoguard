...
const alpsolar = {
  ...
  title: 'Energía Solar · Packs Instalados SPRO',
  description: '¿Estás construyendo una cabaña o quieres dejar de pagar una cuenta elevada de luz? Aprovecha nuestros packs instalados llave en mano. Todos los packs incluyen el mismo inversor SUNPRO de 11 kW — puedes partir con el Pack Inicial y escalar añadiendo paneles y baterías cuando lo necesites, sin cambiar el inversor.',
  features: ['Inversor 11 kW · escala sin cambiarlo', 'WiFi y Bluetooth + app móvil', 'Compatible con generador diésel/gasolina', 'Autonomía eléctrica', 'Paneles 610W Bifacial alta eficiencia', 'IP66 · apto intemperie'],
  planes: [
    {
      featured: true,
      badge: '⭐ Recomendado',
      ...
      planId: 'pack-inicial',
      precioNum: 2490000,
      items: ['3 paneles Trina Solar 610W Bifacial', 'Inversor híbrido SUNPRO 11 kW', 'Batería LiFePO4 5.12 kWh SPRO LC', 'Cableado, cajas de protección y soporte', 'Instalación y puesta en marcha'],
    },
    {
      featured: false,
      ...
      desc: 'Produce ~600 kWh/mes · ideal para hogares con consumo de 300–500 kWh/mes. Sistema híbrido con doble batería para mayor autonomía nocturna y cortes de luz.',
      precio: '$3.990.000',
      nota: 'IVA incluido · instalado',
      ahorro: '$100.000',
      ...
      precioNum: 3990000,
      items: ['6 paneles Trina Solar 610W Bifacial', 'Inversor híbrido SUNPRO 11 kW', '2× Batería LiFePO4 5.12 kWh SPRO LC', 'Cableado, cajas de protección y soporte', 'Instalación y puesta en marcha'],
    },
    {
      featured: false,
      badge: 'Pack Full',
      ...
      planId: 'pack-full',
      precioNum: 5590000,
      items: ['10 paneles Trina Solar 610W Bifacial', 'Inversor híbrido SUNPRO 11 kW', '3× Batería LiFePO4 5.12 kWh SPRO LC', 'Cableado, cajas de protección y soporte', 'Instalación y puesta en marcha'],
    },
  ],
}
